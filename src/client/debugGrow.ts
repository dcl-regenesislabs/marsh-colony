...
// Care-area corner (objects sit ~x195-214, z235-249), floating just off the floor.
const POS = Vector3.create(210, 1.1, 236)

export function setupDebugGrow(): void {
  const e = engine.addEntity()
  Transform.create(e, { position: POS, scale: Vector3.create(0.5, 0.5, 0.5) })
